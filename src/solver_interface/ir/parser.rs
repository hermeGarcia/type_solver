...
mod __parse__Constraint {
    ...
    {
        // Constraint = Xtype, "=", Xtype => ActionFn(2);
    ...
    {
        // Xtype1 = Xtype0, "->", Xtype1 => ActionFn(4);
        assert!(__symbols.len() >= 3);
        let __sym2 = __pop_Variant5(__symbols);
        let __sym1 = __pop_Variant0(__symbols);
        let __sym0 = __pop_Variant5(__symbols);
...
mod __parse__Xtype {
    ...
    pub struct XtypeParser {
        builder: __lalrpop_util::lexer::MatcherBuilder,
        _priv: (),
    }

    impl XtypeParser {
        pub fn new() -> XtypeParser {
            let __builder = super::__intern_token::new_builder();
            XtypeParser {
                builder: __builder,
                _priv: (),
        ...
        >(
            &self,
            input: &'input str,
        ) -> Result<Xtype, __lalrpop_util::ParseError<usize, Token<'input>, &'static str>>
        {
            let mut __tokens = self.builder.matcher(input);
            __state_machine::Parser::drive(
                __StateMachine {
    ...
    >(
        ...
        __symbols: &mut alloc::vec::Vec<(usize,__Symbol<'input>,usize)>,
        _: core::marker::PhantomData<(&'input ())>,
    ) -> Option<Result<Xtype,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
        let (__pop_states, __nonterminal) = match __action {
            0 => {
                __reduce0(input, __lookahead_start, __symbols, core::marker::PhantomData::<(&())>)
...
pub use self::__parse__Xtype::XtypeParser;
#[cfg_attr(rustfmt, rustfmt_skip)]
mod __intern_token {
    #![allow(unused_imports)]
    use crate::solver_interface::ir::*;
